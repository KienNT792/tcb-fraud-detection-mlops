...
_FEATURE_COLS = [
    "amount", "amount_log", "tx_count_last_1h", "tx_count_last_24h",
    "time_since_last_tx_min", "avg_amount_last_30d", "amount_ratio_vs_avg",
    "distance_from_home_km", "is_new_device", "is_new_merchant",
    "cvv_match", "is_3d_secure", "transaction_hour", "transaction_day_of_week",
    "is_night_transaction", "segment_encoded", "customer_tx_count",
    "customer_avg_amount", "card_type", "card_tier", "currency",
    "merchant_category", "merchant_country", "device_type", "os",
    "ip_country", "transaction_status",
]
